...
export const useImportCodeSystemVersionSnomedQuery = (codesystemId: number, codesystemVersionId: number, conceptFile: File, descriptionFile: File, associationFile: File) => {
  ...
  const fetchOptions: CodeSystemQueryOptions<paths['/codesystems/{codesystem_id}/versions/{codesystem-version_id}/import/snomedct']['post']> = {
    ...
    body: formData as unknown as { concept: string, description: string, association: string}
  }
