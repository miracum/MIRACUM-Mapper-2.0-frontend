    ...
    <DataTable :value="transformedMappings" tableStyle="min-width: 50rem" responsiveLayout="scroll">
        <ColumnGroup type="header">
            <Row>
                ...
                <Column header="Status" v-if="props.project.status_required" :rowspan="2" field="status"></Column>
                <Column header="Equivalence" v-if="props.project.equivalence_required" :rowspan="2" sortable
                    field="equivalence"></Column>
                <Column header="Comment" :rowspan="2" sortable field="comment"></Column>
            </Row>
            <Row>
